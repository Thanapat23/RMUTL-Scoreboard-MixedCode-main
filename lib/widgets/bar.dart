...
void showToastErrorConnect(BuildContext context) {
  FToast fToast = FToast();
  fToast.init(context);
  Widget toast = Container(
    width: 100.w,
    ...
    child: Row(
      ...
      children: [
        ...
        Expanded(
            child: Text(
          'Path name does not match the path of the ESP board.',
          style: TextStyle(fontSize: 15.sp, color: Colors.white),
          textAlign: TextAlign.center,
        ))
      ],
...
void showToastAlert(BuildContext context) {
  FToast fToast = FToast();
  fToast.init(context);
  Widget toast = Container(
    width: 80.w,
    ...
    child: Row(
      ...
      children: [
        ...
        Expanded(
            child: Text(
          "Please go set the firebase path.",
          style: TextStyle(fontSize: 15.sp, color: Colors.white),
          textAlign: TextAlign.center,
        ))
      ],
...
void showToastWiFi(BuildContext context) {
  FToast fToast = FToast();
  fToast.init(context);
  Widget toast = Container(
    width: 70.w,
